        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    privacySection("Purchases & reminders", "Apple processes subscriptions and payment information. Omni verifies your subscription and links it to the Omni account used to subscribe. Optional reminders are scheduled on your device, with generic text that doesn't reveal your journal.")
