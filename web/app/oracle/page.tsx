...
export default function OraclePage() {
    ...
    return (
        <div className="relative h-[80vh] flex flex-col">
            ...
            <div className="relative z-10 max-w-4xl mx-auto w-full h-full flex flex-col gap-6">
                ...
                <div className="flex-1 overflow-y-auto bg-neutral-900/40 border border-neutral-800 rounded-2xl p-4 space-y-4 scrollbar-thin backdrop-blur-md">
                    {messages.map((m, i) => (
                        <motion.div
                            key={i}
                ...
                <div className="shrink-0 relative">
                    <input
                        ...
                        className="w-full bg-neutral-900/80 border border-neutral-800 rounded-xl pl-4 pr-32 py-4 focus:border-aurum/50 outline-none transition-colors shadow-lg backdrop-blur"
                    />
